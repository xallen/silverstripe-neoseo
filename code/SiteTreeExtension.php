<?php
	...
	class SiteTreeExtension extends DataObjectDecorator {
		...
		/**
		 * Shortcut to set control the output of MetaTags by overriding values from SiteTree.
		 * 
		 * @param array $tags Array of tags with new values.
		 */
		public function overrideMetaTags($tags) {
